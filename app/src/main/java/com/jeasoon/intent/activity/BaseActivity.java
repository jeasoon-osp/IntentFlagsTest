...
import com.jeasoon.intent.IntentApplication;
...
public abstract class BaseActivity extends Activity {
    ...
    private void showStackWindow() {
        ...
        if (IntentApplication.isStackWindowOpened()) {
            IntentApplication.closeStackWindow();
        } else {
            IntentApplication.openStackWindow();
        }
    }
